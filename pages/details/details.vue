<template>
	<view>
		...
		<view class="cmt_input" v-if="showCmt">
			<input v-model="commentText" placeholder="请输入评论内容" placeholder-class="placeholder" @confirm="addComment"  />
		</view>
		<view class="canvas-box">
			<canvas canvas-id="canvas" class="canvas" style="width: 350px; height: 600px;"></canvas>
			</view>
